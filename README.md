...
1. Log in to [SecurePass Pro Dashboard](https://securepasspro.co)
...
**🤖 Automated releases:** [AUTOMATED_RELEASES.md](./docs/AUTOMATED_RELEASES.md)
...
- `options` (object, optional):
  - `baseURL` (string): Custom API URL (default: auto-detected from browser or `https://securepasspro.co/api`)
...
- **GitHub**: [https://github.com/securepasspro/SDK](https://github.com/securepasspro/SDK)
