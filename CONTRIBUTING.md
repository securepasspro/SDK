...
1. **Check existing issues** - Search [GitHub Issues](https://github.com/securepasspro/securepass-pro-sdk/issues) first
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/securepass-pro-sdk.git
