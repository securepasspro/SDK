...
1. **Log in** to your SecurePass Pro account at [https://securepasspro.co](https://securepasspro.co)
...
1. Download the SDK files from [GitHub Releases](https://github.com/securepasspro/sdk/releases)
2. Choose the format you need:
   - `securepasspro.js` - UMD (Universal Module Definition)
...
<!-- ES Module -->
<script type="module">
  import SecurePassSDK from './lib/securepasspro.esm.js';
</script>

<!-- Or UMD -->
<script src="./lib/securepasspro.js"></script>
```
...
const sdk = new SecurePassSDK('spro_your-api-key-here', {
  baseURL: 'https://securepasspro.co/api', // Optional: custom API URL
...
- **GitHub Issues**: [https://github.com/securepasspro/SDK/issues](https://github.com/securepasspro/SDK/issues)
